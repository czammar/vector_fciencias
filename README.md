...
* El formato debe ser formal y suficientemente claro para abstraer la información relevante del candidato *en relación con el puesto*.
...
* Identificación de programas para nuevos talentos:
* Sitios como: Compu Trabajo, OCC,
